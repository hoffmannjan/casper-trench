...
const bt = 'modulepreload',
	...
	ue = [
		() =>
			le(
				() => import('./pages/__layout.svelte-2a77b734.js'),
				[
					'pages/__layout.svelte-2a77b734.js',
					'assets/pages/__layout.svelte-3905c1d9.css',
					'chunks/index-d017537a.js'
				]
			),
		() =>
			le(
				() => import('./error.svelte-85ba12e6.js'),
				['error.svelte-85ba12e6.js', 'chunks/index-d017537a.js']
			),
		() =>
			le(
				() => import('./pages/components.svelte-c626bf5e.js'),
				[
					'pages/components.svelte-c626bf5e.js',
					'assets/pages/components.svelte-714453e1.css',
					'chunks/index-d017537a.js'
				]
			),
		() =>
			le(
				() => import('./pages/index.svelte-b9c5fedc.js'),
				[
					'pages/index.svelte-b9c5fedc.js',
					'assets/pages/index.svelte-deb4772c.css',
					'chunks/index-d017537a.js'
				]
			)
	],
	$t = { '': [[0, 3], [1]], components: [[0, 2], [1]] };
function kt(s) {
	s.client;
}
function qe(s) {
