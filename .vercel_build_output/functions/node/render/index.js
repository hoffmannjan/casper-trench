...
// node_modules/.pnpm/@sveltejs+kit@1.0.0-next.360_svelte@3.46.4+vite@2.9.13/node_modules/@sveltejs/kit/dist/chunks/_commonjsHelpers.js
var commonjsGlobal;
...
// node_modules/.pnpm/@sveltejs+kit@1.0.0-next.360_svelte@3.46.4+vite@2.9.13/node_modules/@sveltejs/kit/dist/chunks/multipart-parser.js
...
// node_modules/.pnpm/@sveltejs+kit@1.0.0-next.360_svelte@3.46.4+vite@2.9.13/node_modules/@sveltejs/kit/dist/node.js
...
var init_node = __esm({
	'node_modules/.pnpm/@sveltejs+kit@1.0.0-next.360_svelte@3.46.4+vite@2.9.13/node_modules/@sveltejs/kit/dist/node.js'() {
		...
		extractContentType = (body2, request2) => {
			...
			if (
				import_node_buffer.Buffer.isBuffer(body2) ||
				import_node_util.types.isAnyArrayBuffer(body2) ||
...
// .svelte-kit/output/server/chunks/index-acb0298c.js
function run(fn) {
	return fn();
}
...
var init_layout_svelte = __esm({
	'.svelte-kit/output/server/entries/pages/__layout.svelte.js'() {
		...
		_layout = create_ssr_component(($$result, $$props, $$bindings, slots) => {
			return `${
				(($$result.head += `${(($$result.title = `<title>Occhio Studios</title>`), '')}`), '')
			}
...
var init__ = __esm({
	'.svelte-kit/output/server/nodes/0.js'() {
		init_layout_svelte();
		index = 0;
		file2 = 'pages/__layout.svelte-2a77b734.js';
		imports = ['pages/__layout.svelte-2a77b734.js', 'chunks/index-d017537a.js'];
		stylesheets = ['assets/pages/__layout.svelte-3905c1d9.css'];
	}
});
...
var init__2 = __esm({
	'.svelte-kit/output/server/nodes/1.js'() {
		init_error_svelte();
		index2 = 1;
		file3 = 'error.svelte-85ba12e6.js';
		imports2 = ['error.svelte-85ba12e6.js', 'chunks/index-d017537a.js'];
		stylesheets2 = [];
	}
});
...
var durationUnitRegex, range, css$2, Jumper, Heading, css$1, Icon, OcchioLogo, css, Main, Routes;
var init_index_svelte = __esm({
	'.svelte-kit/output/server/entries/pages/index.svelte.js'() {
		...
		Jumper = create_ssr_component(($$result, $$props, $$bindings, slots) => {
			...
			return `<div class="${'wrapper svelte-f3v7i'}" style="${
				'--size: ' +
				escape(size) +
				escape(unit) +
				'; --color: ' +
				...
				escape(duration) +
				';'
			}">${each(range(3, 1), (version) => {
				return `<div class="${'circle svelte-f3v7i'}" style="${
					'animation-delay: ' + escape((durationNum / 3) * (version - 1) + durationUnit) + ';'
				}"></div>`;
			})}</div>`;
		});
		Heading = create_ssr_component(($$result, $$props, $$bindings, slots) => {
			return `
<h1 class="${'text-xl ' + escape($$props.class)}">${slots.default ? slots.default({}) : ``}</h1>`;
		});
		css$1 = {
			code: '.icon.svelte-zayrdb.svelte-zayrdb{align-items:center;display:flex;justify-content:center;max-width:100%}.icon.svelte-zayrdb.svelte-zayrdb,.icon.svelte-zayrdb img.svelte-zayrdb,.icon.svelte-zayrdb svg.svelte-zayrdb{max-height:100%}.icon.svelte-zayrdb img.svelte-zayrdb,.icon.svelte-zayrdb svg.svelte-zayrdb{max-width:100%}',
			map: null
		};
		Icon = create_ssr_component(($$result, $$props, $$bindings, slots) => {
			let $$slots = compute_slots(slots);
			$$result.css.add(css$1);
			return `<div class="${'icon ' + escape($$props.class) + ' svelte-zayrdb'}">${
				$$slots.img
					? `
		${
			slots.img
		...
		OcchioLogo = create_ssr_component(($$result, $$props, $$bindings, slots) => {
			return `<svg width="${'132'}" height="${'25'}" viewBox="${'0 0 132 25'}" fill="${'none'}" xmlns="${'http://www.w3.org/2000/svg'}"><path d="${'M24.3555 6.23425L29.9454 6.23425'}" stroke="${'url(#paint0_linear_26_1157)'}" stroke-width="${'3'}" stroke-miterlimit="${'10'}"></path><path d="${'M48.7695 9.7745V6.09448C48.7695 4.83675 49.8409 3.85852 51.1452 3.85852C52.4495 3.85852 53.5209 4.88334 53.5209 6.09448V9.7745'}" stroke="${'url(#paint1_linear_26_1157)'}" stroke-width="${'3'}" stroke-miterlimit="${'10'}"></path><path d="${'M12.4811 22.7245C18.2696 22.7245 22.9621 18.0319 22.9621 12.2434C22.9621 6.45486 18.2696 1.76233 12.4811 1.76233C6.69253 1.76233 2 6.45486 2 12.2434C2 18.0319 6.69253 22.7245 12.4811 22.7245Z'}" stroke="${'black'}" stroke-width="${'3'}" stroke-miterlimit="${'10'}"></path><path d="${'M119.155 22.7245C124.943 22.7245 129.636 18.0319 129.636 12.2434C129.636 6.45486 124.943 1.76233 119.155 1.76233C113.366 1.76233 108.674 6.45486 108.674 12.2434C108.674 18.0319 113.366 22.7245 119.155 22.7245Z'}" stroke="${'black'}" stroke-width="${'3'}" stroke-miterlimit="${'10'}"></path><path d="${'M44.8556 20.6283C43.0855 21.9326 40.9427 22.7245 38.567 22.7245C32.7908 22.7245 28.0859 18.0196 28.0859 12.2434C28.0859 6.46716 32.7908 1.76233 38.567 1.76233C40.9427 1.76233 43.1321 2.55423 44.8556 3.85854'}" stroke="${'black'}" stroke-width="${'3'}" stroke-miterlimit="${'10'}"></path><path d="${'M44.8555 3.85852C47.4175 5.7684 49.0479 8.79627 49.0479 12.2434C49.0479 15.6905 47.4175 18.7183 44.8555 20.6282'}" stroke="${'url(#paint2_linear_26_1157)'}" stroke-width="${'3'}" stroke-miterlimit="${'10'}"></path><path d="${'M70.0099 20.6283C68.2398 21.9326 66.097 22.7245 63.7213 22.7245C57.9451 22.7245 53.2402 18.0196 53.2402 12.2434C53.2402 6.46716 57.9451 1.76233 63.7213 1.76233C66.097 1.76233 68.2864 2.55423 70.0099 3.85854'}" stroke="${'black'}" stroke-width="${'3'}" stroke-miterlimit="${'10'}"></path><path d="${'M70.0098 3.85852C72.5718 5.7684 74.2022 8.79627 74.2022 12.2434C74.2022 15.6905 72.5718 18.7183 70.0098 20.6282'}" stroke="${'url(#paint3_linear_26_1157)'}" stroke-width="${'3'}" stroke-miterlimit="${'10'}"></path><path d="${'M79.3271 0.364868L79.3271 24.122'}" stroke="${'black'}" stroke-width="${'3'}" stroke-miterlimit="${'10'}"></path><path d="${'M96.0967 0.364868L96.0967 24.122'}" stroke="${'black'}" stroke-width="${'3'}" stroke-miterlimit="${'10'}"></path><path d="${'M79.3271 12.4762H96.0969'}" stroke="${'black'}" stroke-width="${'3'}" stroke-miterlimit="${'10'}"></path><path d="${'M102.618 0.364868L102.618 24.122'}" stroke="${'black'}" stroke-width="${'3'}" stroke-miterlimit="${'10'}"></path><path d="${'M71.5938 6.23425H77.1837'}" stroke="${'url(#paint4_linear_26_1157)'}" stroke-width="${'3'}" stroke-miterlimit="${'10'}"></path><defs><linearGradient id="${'paint0_linear_26_1157'}" x1="${'27.1504'}" y1="${'6.23425'}" x2="${'27.1504'}" y2="${'7.23425'}" gradientUnits="${'userSpaceOnUse'}"><stop stop-color="${'#B0B0B0'}"></stop><stop offset="${'1'}" stop-color="${'#A0A0A0'}" stop-opacity="${'0'}"></stop></linearGradient><linearGradient id="${'paint1_linear_26_1157'}" x1="${'51.1452'}" y1="${'3.85852'}" x2="${'51.1452'}" y2="${'9.7745'}" gradientUnits="${'userSpaceOnUse'}"><stop stop-color="${'#B0B0B0'}"></stop><stop offset="${'1'}" stop-color="${'#A0A0A0'}" stop-opacity="${'0'}"></stop></linearGradient><linearGradient id="${'paint2_linear_26_1157'}" x1="${'46.9517'}" y1="${'3.85852'}" x2="${'46.9517'}" y2="${'20.6282'}" gradientUnits="${'userSpaceOnUse'}"><stop stop-color="${'#B0B0B0'}"></stop><stop offset="${'1'}" stop-color="${'#A0A0A0'}" stop-opacity="${'0'}"></stop></linearGradient><linearGradient id="${'paint3_linear_26_1157'}" x1="${'72.106'}" y1="${'3.85852'}" x2="${'72.106'}" y2="${'20.6282'}" gradientUnits="${'userSpaceOnUse'}"><stop stop-color="${'#B0B0B0'}"></stop><stop offset="${'1'}" stop-color="${'#A0A0A0'}" stop-opacity="${'0'}"></stop></linearGradient><linearGradient id="${'paint4_linear_26_1157'}" x1="${'74.3887'}" y1="${'6.23425'}" x2="${'74.3887'}" y2="${'7.23425'}" gradientUnits="${'userSpaceOnUse'}"><stop stop-color="${'#B0B0B0'}"></stop><stop offset="${'1'}" stop-color="${'#A0A0A0'}" stop-opacity="${'0'}"></stop></linearGradient></defs></svg>`;
		});
		css = {
			code: '.svelte-1lyw79n{font-family:Inter,sans-serif;text-align:center}main.svelte-1lyw79n{align-items:center;display:flex;flex-direction:column;height:100vh;justify-content:center;width:100vw}',
			map: null
		};
		Main = create_ssr_component(($$result, $$props, $$bindings, slots) => {
			$$result.css.add(css);
			return `<main class="${'svelte-1lyw79n'}">
	${validate_component(Icon, 'Icon').$$render(
		...
		{
			default: () => {
				return `<img src="${'/images/png/logo.png'}" alt="${'JEM LOGO'}" class="${'svelte-1lyw79n'}">`;
			}
		}
	)}
	...
	${validate_component(Icon, 'Icon').$$render(
		$$result,
		{ slot: 'svg', class: 'h-24 w-24 my-1' },
		{},
		{
			default: () => {
				return `${validate_component(OcchioLogo, 'OcchioLogo').$$render($$result, {}, {}, {})}`;
			}
		}
	)}
	...
	${validate_component(Heading, 'Heading').$$render(
		...
		{
			default: () => {
				return `Occhio Studios - Base Project`;
			}
		}
	)}
...
var init__3 = __esm({
	'.svelte-kit/output/server/nodes/3.js'() {
		init_index_svelte();
		index3 = 3;
		file4 = 'pages/index.svelte-b9c5fedc.js';
		imports3 = ['pages/index.svelte-b9c5fedc.js', 'chunks/index-d017537a.js'];
		stylesheets3 = ['assets/pages/index.svelte-deb4772c.css'];
	}
});
...
var init_components_svelte = __esm({
	'.svelte-kit/output/server/entries/pages/components.svelte.js'() {
		init_index_acb0298c();
		css$7 = {
			code: '.bottom-footer.svelte-13tne86{display:flex;height:clamp(50px,5.71vw,5.71vw);padding:clamp(16px,1.43vw,1.43vw) clamp(16px,3.75vw,3.75vw);position:relative}.bg.svelte-13tne86{bottom:0;display:none;height:100%;left:0;position:absolute;right:0;top:0;width:100%;z-index:-10}@media(min-width:768px){.bg.svelte-13tne86{display:block}}.powered-by.svelte-13tne86{font-size:clamp(8px,.77vw,.77vw);margin-right:clamp(200px,34.17vw,34.17vw)}.label.svelte-13tne86{--tw-text-opacity:1;color:rgb(143 147 152/var(--tw-text-opacity))}.value.svelte-13tne86,.versions.svelte-13tne86{--tw-text-opacity:1;color:rgb(255 255 255/var(--tw-text-opacity))}.versions.svelte-13tne86{font-size:clamp(8px,.65vw,.65vw)}',
			map: null
		};
		BottomFooter = create_ssr_component(($$result, $$props, $$bindings, slots) => {
			$$result.css.add(css$7);
			return `<div class="${'bottom-footer svelte-13tne86'}"><img src="${'/images/png/b-footer-bg.png'}" alt="${'bg'}" class="${'bg svelte-13tne86'}" draggable="${'false'}">

	<div class="${'powered-by svelte-13tne86'}"><div class="${'label svelte-13tne86'}">Powered by</div>
		<div class="${'value svelte-13tne86'}">MAKE Technology LLC</div></div>

	<div class="${'versions svelte-13tne86'}"><div>CSPR.live version: 1.10.0 (4287b143)</div>
		<div>Casper Network Node version: 1.4.6 (72b698e89)</div>
		<div>Quote Data provided by CoinGecko API</div></div>
</div>`;
		});
		ArcadiaLogo = create_ssr_component(($$result, $$props, $$bindings, slots) => {
			return `<svg width="${'141'}" height="${'40'}" class="${'w-full h-full'}" viewBox="${'0 0 141 40'}" fill="${'none'}" xmlns="${'http://www.w3.org/2000/svg'}"><path d="${'M9.97723 18.373L9.17961 18.0312L3.56152 23.6228L3.87364 24.4511L9.97723 18.373Z'}" fill="${'white'}"></path><path d="${'M21.1406 23.1601L20.343 22.8184L7.89307 35.2094L8.20518 36.0378L21.1406 23.1601Z'}" fill="${'white'}"></path><path d="${'M11.5728 19.0565L10.7752 18.7148L4.18262 25.2797L4.49126 26.1081L11.5728 19.0565Z'}" fill="${'white'}"></path><path d="${'M14.7631 20.4267L13.9654 20.085L5.42041 28.5896L5.72906 29.4179L14.7631 20.4267Z'}" fill="${'white'}"></path><path d="${'M16.3582 21.1093L15.5606 20.7676L6.0376 30.2455L6.34625 31.0705L16.3582 21.1093Z'}" fill="${'white'}"></path><path d="${'M19.5455 22.4765L18.7479 22.1348L7.27588 33.5559L7.58453 34.3809L19.5455 22.4765Z'}" fill="${'white'}"></path><path d="${'M17.9533 21.7929L17.1557 21.4512L6.6582 31.899L6.96685 32.7274L17.9533 21.7929Z'}" fill="${'white'}"></path><path d="${'M13.168 19.7426L12.3703 19.3975L4.7998 26.9322L5.10845 27.7606L13.168 19.7426Z'}" fill="${'white'}"></path><path d="${'M2.00457 14.9555L1.20694 14.6104L0.468262 15.349L0.77691 16.1739L2.00457 14.9555Z'}" fill="${'white'}"></path><path d="${'M3.59966 15.6386L2.80204 15.2969L1.08887 17.0019L1.39751 17.8303L3.59966 15.6386Z'}" fill="${'white'}"></path><path d="${'M0 14.0928L0.159526 14.5208L0.409218 14.2688L0 14.0928Z'}" fill="${'white'}"></path><path d="${'M6.7904 17.0058L5.99277 16.6641L2.32715 20.3123L2.6358 21.1407L6.7904 17.0058Z'}" fill="${'white'}"></path><path d="${'M5.19481 16.3222L4.39719 15.9805L1.70605 18.6589L2.0147 19.4838L5.19481 16.3222Z'}" fill="${'white'}"></path><path d="${'M8.38555 17.6894L7.58792 17.3477L2.94434 21.9693L3.25298 22.7977L8.38555 17.6894Z'}" fill="${'white'}"></path><path d="${'M37.211 32.1473V31.0117L28.1943 39.9892H29.3353L37.211 32.1473Z'}" fill="${'white'}"></path><path d="${'M33.8991 28.6308L33.1015 28.2891L21.3486 39.9898H22.4896L33.8991 28.6308Z'}" fill="${'white'}"></path><path d="${'M37.2113 34.4188V33.2832L30.4766 39.9896H31.6175L37.2113 34.4188Z'}" fill="${'white'}"></path><path d="${'M35.4947 29.3178L34.6971 28.9727L23.6309 39.99H24.7718L35.4947 29.3178Z'}" fill="${'white'}"></path><path d="${'M37.0898 30.0009L36.2922 29.6592L25.9126 39.9897H27.0536L37.0898 30.0009Z'}" fill="${'white'}"></path><path d="${'M37.211 38.9608V37.8252L35.0366 39.9893H36.181L37.211 38.9608Z'}" fill="${'white'}"></path><path d="${'M37.2111 36.6902V35.5547L32.7583 39.9899H33.8993L37.2111 36.6902Z'}" fill="${'white'}"></path><path d="${'M29.1134 26.58L28.3193 26.2383L14.5029 39.9893H15.6439L29.1134 26.58Z'}" fill="${'white'}"></path><path d="${'M32.3041 27.9472L31.5064 27.6055L19.0669 39.9896H20.2079L32.3041 27.9472Z'}" fill="${'white'}"></path><path d="${'M25.9267 25.2138L25.1291 24.8721L9.93945 39.9899H11.0804L25.9267 25.2138Z'}" fill="${'white'}"></path><path d="${'M24.3309 24.5272L23.5333 24.1855L9.13086 38.5198L9.43951 39.3482L24.3309 24.5272Z'}" fill="${'white'}"></path><path d="${'M27.5218 25.8964L26.7242 25.5547L12.2212 39.9891H13.3621L27.5218 25.8964Z'}" fill="${'white'}"></path><path d="${'M30.709 27.2636L29.9114 26.9219L16.7852 39.9894H17.9261L30.709 27.2636Z'}" fill="${'white'}"></path><path d="${'M22.7357 23.8437L21.9381 23.502L8.51367 36.8664L8.82232 37.6913L22.7357 23.8437Z'}" fill="${'white'}"></path><path d="${'M20.121 6.8584L18.2379 7.59703L14.2012 11.6146L15.0196 11.9356L20.121 6.8584Z'}" fill="${'white'}"></path><path d="${'M22.4894 6.77187V5.92969L22.0039 6.11952L15.8379 12.2564L16.6563 12.5774L22.4894 6.77187Z'}" fill="${'white'}"></path><path d="${'M11.0938 10.3963L11.7457 10.6517L12.5919 9.80957L11.0938 10.3963Z'}" fill="${'white'}"></path><path d="${'M16.3549 8.33203L14.4753 9.07066L12.5645 10.9725L13.3829 11.2935L16.3549 8.33203Z'}" fill="${'white'}"></path><path d="${'M22.4898 9.04279V7.90723L17.4751 12.8982L18.2935 13.2192L22.4898 9.04279Z'}" fill="${'white'}"></path><path d="${'M22.4896 11.3143V10.1787L19.1118 13.5405L19.9303 13.8615L22.4896 11.3143Z'}" fill="${'white'}"></path><path d="${'M22.4898 14.7207L22.3857 14.8242L22.4898 14.8622V14.7207Z'}" fill="${'white'}"></path><path d="${'M22.4899 13.5848V12.4492L20.749 14.1819L21.5675 14.5029L22.4899 13.5848Z'}" fill="${'white'}"></path><path d="${'M35.7579 0.310547L33.7985 1.12511L29.2451 5.657V6.79256L35.7579 0.310547Z'}" fill="${'white'}"></path><path d="${'M37.211 3.40704V2.27148L29.2451 10.1997V11.3353L37.211 3.40704Z'}" fill="${'white'}"></path><path d="${'M37.211 5.67755V4.54199L29.2451 12.4702V13.6058L37.211 5.67755Z'}" fill="${'white'}"></path><path d="${'M37.211 9.08398L29.2451 17.0122V17.2711L29.8728 17.523L37.211 10.2195V9.08398Z'}" fill="${'white'}"></path><path d="${'M31.8391 1.93945L29.8798 2.75402L29.2451 3.38565V4.52121L31.8391 1.93945Z'}" fill="${'white'}"></path><path d="${'M37.211 1.13556V0L29.2451 7.92821V9.06377L37.211 1.13556Z'}" fill="${'white'}"></path><path d="${'M37.2113 17.033V15.8975L33.9341 19.1626L34.7456 19.4871L37.2113 17.033Z'}" fill="${'white'}"></path><path d="${'M37.211 7.94904V6.81348L29.2451 14.7417V15.8772L37.211 7.94904Z'}" fill="${'white'}"></path><path d="${'M37.2109 20.4404L37.1797 20.4715L37.2109 20.4853V20.4404Z'}" fill="${'white'}"></path><path d="${'M37.2109 19.3045V18.1689L35.5566 19.8153L36.3681 20.1432L37.2109 19.3045Z'}" fill="${'white'}"></path><path d="${'M37.2113 14.7625V13.627L32.3076 18.5074L33.1191 18.8353L37.2113 14.7625Z'}" fill="${'white'}"></path><path d="${'M37.2113 12.491V11.3555L30.6846 17.8513L31.4961 18.1792L37.2113 12.491Z'}" fill="${'white'}"></path><path d="${'M44.1608 1.81895H41.4385V0.0137939H48.8495V1.81895H46.1271V8.91189H44.1608V1.81895Z'}" fill="${'white'}"></path><path d="${'M50.3545 0.0137939H52.3208V3.53437H55.9518V0.0137939H57.9181V8.91189H55.9518V5.33953H52.3208V8.91189H50.3545V0.0137939Z'}" fill="${'white'}"></path><path d="${'M60.0615 0.0137939H66.8067V1.75337H62.0174V3.55854H66.2345V5.30157H62.0174V7.16886H66.8726V8.91189H60.0615V0.0137939Z'}" fill="${'white'}"></path><path d="${'M47.4141 12.8574H50.2995L56.4031 27.133H53.1294L51.8254 23.9542H45.805L44.5046 27.133H41.3105L47.4141 12.8574ZM50.7087 21.1998L48.8152 16.6058L46.9252 21.1998H50.7087Z'}" fill="${'white'}"></path><path d="${'M58.5981 12.9502H65.1075C66.9178 12.9502 68.3223 13.4541 69.269 14.386C69.6796 14.8178 69.9991 15.327 70.2088 15.8837C70.4185 16.4403 70.514 17.0331 70.4898 17.627V17.665C70.4898 19.9534 69.2482 21.3927 67.438 22.0588L70.9059 27.1223H67.2438L64.192 22.5869H61.7332V27.1223H58.612L58.5981 12.9502ZM64.9064 19.8533C66.4323 19.8533 67.3062 19.0422 67.3062 17.8479V17.81C67.3062 16.4708 66.3698 15.7839 64.8439 15.7839H61.7228V19.8533H64.9064Z'}" fill="${'white'}"></path><path d="${'M72.661 20.0849V20.0469C72.661 16.0155 75.7128 12.7158 80.0859 12.7158C82.77 12.7158 84.3792 13.6063 85.7004 14.9041L83.7064 17.1925C82.607 16.1984 81.4903 15.591 80.065 15.591C77.6652 15.591 75.9347 17.5756 75.9347 20.0055V20.0469C75.9347 22.463 77.6236 24.4994 80.065 24.4994C81.6915 24.4994 82.6903 23.8505 83.807 22.8392L85.801 24.8446C84.3376 26.4047 82.7111 27.3745 79.9645 27.3745C78.9993 27.39 78.0409 27.2119 77.1464 26.8507C76.2519 26.4896 75.4397 25.9529 74.7581 25.2726C74.0765 24.5923 73.5395 23.7824 73.1792 22.8911C72.8189 21.9998 72.6427 21.0454 72.661 20.0849Z'}" fill="${'white'}"></path><path d="${'M93.1978 12.8574H96.0867L102.19 27.133H98.913L97.6125 23.9542H91.5922L90.2882 27.133H87.0942L93.1978 12.8574ZM96.4924 21.1998L94.6024 16.6058L92.7089 21.1998H96.4924Z'}" fill="${'white'}"></path><path d="${'M104.386 12.9502H109.934C114.412 12.9502 117.502 16.0048 117.502 19.9948V20.0362C117.502 24.0228 114.412 27.1223 109.934 27.1223H104.386V12.9502ZM109.934 24.3058C112.497 24.3058 114.228 22.58 114.228 20.0742V20.0362C114.228 17.5235 112.494 15.7632 109.934 15.7632H107.507V24.3058H109.934Z'}" fill="${'white'}"></path><path d="${'M123.567 12.9609H120.436V27.133H123.567V12.9609Z'}" fill="${'white'}"></path><path d="${'M132.008 12.8574H134.897L140.997 27.133H137.723L136.423 23.9542H130.399L129.098 27.133H125.904L132.008 12.8574ZM135.302 21.1998L133.412 16.6058L131.519 21.1998H135.302Z'}" fill="${'white'}"></path><path d="${'M41.6813 35.4197V35.3852C41.6765 34.7741 41.7949 34.1683 42.0297 33.6036C42.2645 33.039 42.6107 32.5269 43.048 32.0979C43.4852 31.6688 44.0045 31.3315 44.5751 31.1059C45.1457 30.8802 45.756 30.7709 46.3699 30.7843C47.6551 30.7159 48.9158 31.1536 49.8795 32.0027L48.6414 33.4903C48.0122 32.8949 47.1721 32.5711 46.304 32.5895C44.8752 32.5895 43.7377 33.8458 43.7377 35.3507V35.3852C43.7377 37.0143 44.8614 38.2086 46.4462 38.2086C47.1046 38.2276 47.7523 38.0405 48.2981 37.6736V36.4207H46.304V34.7294H50.1881V38.5951C49.1284 39.5068 47.7741 40.008 46.3734 40.0068C43.599 40.0068 41.6743 38.0602 41.6743 35.4266'}" fill="${'white'}"></path><path d="${'M52.0923 30.9463H56.1775C57.315 30.9463 58.1959 31.2638 58.7855 31.8471C59.0427 32.1189 59.2431 32.4389 59.3746 32.7886C59.5062 33.1382 59.5665 33.5105 59.5519 33.8835V33.9077C59.5814 34.5137 59.4096 35.1126 59.0629 35.6117C58.7163 36.1108 58.2142 36.4823 57.6341 36.669L59.8189 39.8478H57.5196L55.6053 37.0003H54.0586V39.8478H52.0923V30.9463ZM56.0527 35.2676C57.0099 35.2676 57.5578 34.7602 57.5578 34.0113V33.9836C57.5578 33.1449 56.9717 32.7135 56.0146 32.7135H54.0586V35.2676H56.0527Z'}" fill="${'white'}"></path><path d="${'M60.9287 35.4198V35.3853C60.9289 34.7689 61.0534 34.1587 61.2949 33.5911C61.5365 33.0234 61.8901 32.5098 62.3348 32.0807C62.7795 31.6516 63.3063 31.3158 63.8838 31.0931C64.4614 30.8704 65.0781 30.7655 65.6971 30.7844C68.4542 30.7844 70.4343 32.8312 70.4343 35.3612V35.3853C70.4346 36.0018 70.3105 36.612 70.0694 37.1798C69.8283 37.7476 69.4751 38.2615 69.0307 38.6909C68.5863 39.1203 68.0598 39.4565 67.4824 39.6796C66.905 39.9027 66.2885 40.0082 65.6694 39.9897C62.895 39.9897 60.9287 37.9395 60.9287 35.4095V35.4198ZM68.3779 35.4095V35.3853C68.3904 35.0232 68.3297 34.6623 68.1993 34.3241C68.0689 33.9858 67.8715 33.6771 67.6188 33.4163C67.3662 33.1554 67.0634 32.9479 66.7285 32.8058C66.3936 32.6638 66.0334 32.5903 65.6694 32.5896C65.309 32.5884 64.9522 32.6597 64.6202 32.7992C64.2883 32.9388 63.9881 33.1436 63.7377 33.4015C63.4874 33.6595 63.2919 33.9651 63.1632 34.3C63.0345 34.635 62.9751 34.9924 62.9887 35.3508V35.3853C62.9761 35.7474 63.0368 36.1083 63.1672 36.4466C63.2976 36.7848 63.495 37.0936 63.7477 37.3544C64.0004 37.6152 64.3032 37.8228 64.638 37.9648C64.9729 38.1068 65.3331 38.1804 65.6971 38.1811C66.0575 38.1823 66.4143 38.1109 66.7463 37.9714C67.0782 37.8319 67.3784 37.627 67.6288 37.3691C67.8792 37.1112 68.0746 36.8056 68.2033 36.4706C68.3321 36.1356 68.3914 35.7782 68.3779 35.4198'}" fill="${'white'}"></path><path d="${'M72.0435 36.0304V30.9463H74.0098V35.9821C74.0098 37.4283 74.738 38.1807 75.938 38.1807C77.1379 38.1807 77.8696 37.4559 77.8696 36.0442V30.9463H79.8359V35.9683C79.8359 38.6639 78.317 39.9859 75.9137 39.9859C73.5104 39.9859 72.0435 38.6501 72.0435 36.0304Z'}" fill="${'white'}"></path><path d="${'M81.8404 30.9463H85.4922C87.625 30.9463 88.915 32.2061 88.915 34.0216V34.0492C88.915 36.1202 87.3059 37.1763 85.2979 37.1763H83.8033V39.8444H81.8369L81.8404 30.9463ZM85.3673 35.4333C86.3487 35.4333 86.9244 34.85 86.9244 34.0872V34.0596C86.9244 33.1829 86.3106 32.7135 85.3292 32.7135H83.8067V35.4333H85.3673Z'}" fill="${'white'}"></path></svg>`;
		});
		CsprLiveLogo = create_ssr_component(($$result, $$props, $$bindings, slots) => {
			return `<svg width="${'121'}" height="${'33'}" viewBox="${'0 0 121 33'}" class="${'w-full h-full'}" fill="${'none'}" xmlns="${'http://www.w3.org/2000/svg'}"><path d="${'M101.526 11.1649C102.682 14.3461 103.818 17.5458 104.972 20.727H107.337L110.783 11.1649H108.547C107.74 13.6988 106.878 16.2881 106.2 18.5816H106.164C105.393 16.0847 104.587 13.6802 103.799 11.1649H101.526Z'}" fill="${'white'}"></path><path d="${'M120.308 16.1212C120.29 13.4209 118.97 10.9055 115.745 10.9055C112.977 10.9055 110.96 13.014 110.96 15.9177C110.96 18.9324 112.904 20.9854 115.745 20.9854C117.981 20.9854 119.612 19.8387 120.18 17.8967H118.072C117.724 18.8584 116.826 19.2654 115.745 19.2654C114.259 19.2654 113.16 18.2667 113.014 16.5281H120.308V16.1212ZM113.05 14.9744C113.27 13.5133 114.259 12.57 115.726 12.57C117.192 12.57 118.054 13.4763 118.201 14.9744H113.05Z'}" fill="${'white'}"></path><path d="${'M100.508 9.66645V7.55794H98.2905V9.66645H100.508ZM98.3453 20.7266H100.453V11.1646H98.3453V20.7266Z'}" fill="${'white'}"></path><path d="${'M94.3057 7.52087V20.7266H96.4322V7.52087H94.3057Z'}" fill="${'white'}"></path><path d="${'M88.2214 22.7161C89.9015 22.7161 91.2635 21.3417 91.2635 19.6463C91.2635 17.9509 89.9015 16.5766 88.2214 16.5766C86.5413 16.5766 85.1792 17.9509 85.1792 19.6463C85.1792 21.3417 86.5413 22.7161 88.2214 22.7161Z'}" fill="${'#0C8D95'}"></path><path d="${'M3.04211 23.1769C4.72222 23.1769 6.08422 21.8025 6.08422 20.1071C6.08422 18.4118 4.72222 17.0374 3.04211 17.0374C1.362 17.0374 0 18.4118 0 20.1071C0 21.8025 1.362 23.1769 3.04211 23.1769Z'}" fill="${'#1647A1'}"></path><path d="${'M19.7735 6.13953C21.4536 6.13953 22.8156 4.76515 22.8156 3.06977C22.8156 1.37438 21.4536 0 19.7735 0C18.0934 0 16.7314 1.37438 16.7314 3.06977C16.7314 4.76515 18.0934 6.13953 19.7735 6.13953Z'}" fill="${'#14549F'}"></path><path d="${'M16.7316 33.0004C18.4117 33.0004 19.7737 31.626 19.7737 29.9306C19.7737 28.2352 18.4117 26.8608 16.7316 26.8608C15.0515 26.8608 13.6895 28.2352 13.6895 29.9306C13.6895 31.626 15.0515 33.0004 16.7316 33.0004Z'}" fill="${'#0E8397'}"></path><path d="${'M70.7163 20.7205H73.1652V15.0024H75.3104C77.0712 15.0024 77.6378 15.9826 78.1032 17.3304C78.5078 18.515 78.7101 19.8424 79.3786 20.7205H82.0095C81.2807 19.7403 81.0578 18.6375 80.6327 17.3101C80.1269 15.615 79.6615 14.5327 78.4272 14.1242C80.1269 13.6953 81.321 12.1636 81.321 10.2849C81.321 7.89544 79.52 6.13916 76.2209 6.13916H70.7163V20.7205ZM73.1652 12.9602V8.16098H76.0187C78.0827 8.16098 78.8926 9.18208 78.8926 10.4687C78.8926 11.9798 77.9215 12.9602 76.1 12.9602H73.1652Z'}" fill="${'white'}"></path><path fill-rule="${'evenodd'}" clip-rule="${'evenodd'}" d="${'M84.6704 20.7209H88.2971V19.1861H83.5479C83.5977 19.2689 83.6517 19.3499 83.7122 19.4316L84.6704 20.7209Z'}" fill="${'#0C8D95'}"></path><path d="${'M70.7163 20.7205H73.1652V15.0024H75.3104C77.0712 15.0024 77.6378 15.9826 78.1032 17.3304C78.5078 18.515 78.7101 19.8424 79.3786 20.7205H82.0095C81.2807 19.7403 81.0578 18.6375 80.6327 17.3101C80.1269 15.615 79.6615 14.5327 78.4272 14.1242C80.1269 13.6953 81.321 12.1636 81.321 10.2849C81.321 7.89544 79.52 6.13916 76.2209 6.13916H70.7163V20.7205ZM73.1652 12.9602V8.16098H76.0187C78.0827 8.16098 78.8926 9.18208 78.8926 10.4687C78.8926 11.9798 77.9215 12.9602 76.1 12.9602H73.1652Z'}" fill="${'white'}"></path><path d="${'M44.523 16.2635H42.081C41.4909 17.8653 40.2089 18.933 37.8281 18.933C34.735 18.933 32.8832 16.4895 32.8832 13.4298C32.8832 10.3702 34.735 7.9267 37.8281 7.9267C40.0461 7.9267 41.3078 8.83022 42.081 10.5961H44.523C43.6276 7.7419 41.4909 5.8322 37.8281 5.8322C33.2901 5.8322 30.4209 9.11773 30.4209 13.4298C30.4209 17.7831 33.2698 21.0275 37.8077 21.0275C41.4503 21.0275 43.8515 18.9946 44.523 16.2635Z'}" fill="${'white'}"></path><path fill-rule="${'evenodd'}" clip-rule="${'evenodd'}" d="${'M12.8607 20.271L18.4704 7.81741L15.9759 29.8431L15.665 32.5879L17.3343 30.3981L24.7113 20.7209H31.2493C31.1196 20.5993 30.9934 20.4735 30.8709 20.3437C30.5298 19.9824 30.2221 19.5953 29.9479 19.186H24.3368H23.9623L23.734 19.4855L17.798 27.2724L20.5292 3.15686L19.0812 2.75215L11.6787 19.186H3.04199V20.7209H12.1683H12.658L12.8607 20.271Z'}" fill="${'url(#paint0_linear_264_679)'}"></path><path d="${'M44.523 16.2635H42.081C41.4909 17.8653 40.2089 18.933 37.8281 18.933C34.735 18.933 32.8832 16.4895 32.8832 13.4298C32.8832 10.3702 34.735 7.9267 37.8281 7.9267C40.0461 7.9267 41.3078 8.83022 42.081 10.5961H44.523C43.6276 7.7419 41.4909 5.8322 37.8281 5.8322C33.2901 5.8322 30.4209 9.11773 30.4209 13.4298C30.4209 17.7831 33.2698 21.0275 37.8077 21.0275C41.4503 21.0275 43.8515 18.9946 44.523 16.2635Z'}" fill="${'white'}"></path><path d="${'M64.0655 6.13916H58.9048V20.7205H61.3536V15.2474H64.0655C67.0406 15.2474 69.1858 13.2665 69.1858 10.632C69.1858 8.05884 67.2024 6.13916 64.0655 6.13916ZM63.8632 13.1848H61.3536V8.20181H63.8632C65.6846 8.20181 66.737 9.01865 66.737 10.6525C66.737 12.2862 65.6846 13.1848 63.8632 13.1848Z'}" fill="${'white'}"></path><path d="${'M54.1225 10.464H56.5584C56.3773 7.29485 54.2836 5.8322 51.3644 5.8322C48.7675 5.8322 46.1907 7.21359 46.2309 9.99668C46.2712 12.8408 48.7071 13.6939 51.0826 14.344C52.9146 14.8519 54.5251 15.1566 54.5251 16.7411C54.5251 18.2445 53.116 18.9758 51.5054 18.9758C49.6332 18.9758 48.2642 17.9194 48.2039 15.9692H45.7075C45.8686 19.4226 48.3246 21.0275 51.5054 21.0275C54.1427 21.0275 56.941 19.6867 56.941 16.7208C56.941 13.6127 54.3239 13.0032 51.8879 12.3329C50.0157 11.825 48.6669 11.2765 48.6669 9.97639C48.6669 8.49337 49.915 7.88395 51.3242 7.88395C53.0556 7.88395 53.9413 8.73716 54.1225 10.464Z'}" fill="${'white'}"></path><defs><linearGradient id="${'paint0_linear_264_679'}" x1="${'9.46586'}" y1="${'7.8375'}" x2="${'26.369'}" y2="${'21.0003'}" gradientUnits="${'userSpaceOnUse'}"><stop stop-color="${'#173BA3'}"></stop><stop offset="${'1'}" stop-color="${'#0C8D94'}"></stop></linearGradient></defs></svg>`;
		});
		DiscordIcon = create_ssr_component(($$result, $$props, $$bindings, slots) => {
			return `<svg width="${'20'}" height="${'16'}" viewBox="${'0 0 20 16'}" class="${'w-full h-full'}" fill="${'none'}" xmlns="${'http://www.w3.org/2000/svg'}"><path d="${'M16.9307 1.74339C15.6557 1.16839 14.2891 0.743393 12.8599 0.501726C12.8472 0.499283 12.834 0.500857 12.8222 0.506232C12.8104 0.511607 12.8006 0.520516 12.7941 0.531726C12.6191 0.839226 12.4241 1.24006 12.2874 1.55673C10.7717 1.33026 9.23067 1.33026 7.71491 1.55673C7.56269 1.20578 7.39104 0.86358 7.20075 0.531726C7.19429 0.520378 7.18454 0.511268 7.17277 0.505609C7.16101 0.499951 7.1478 0.498015 7.13491 0.500059C5.70658 0.741726 4.33991 1.16673 3.06408 1.74256C3.0531 1.74716 3.0438 1.75501 3.03741 1.76506C0.444079 5.57756 -0.266754 9.29589 0.0824122 12.9676C0.0833839 12.9766 0.0861752 12.9853 0.0906163 12.9931C0.0950575 13.001 0.101056 13.0079 0.108246 13.0134C1.62191 14.1154 3.31019 14.9549 5.10241 15.4967C5.11491 15.5006 5.12827 15.5006 5.14076 15.4967C5.15324 15.4928 5.16428 15.4853 5.17241 15.4751C5.55807 14.9593 5.89983 14.4121 6.19408 13.8392C6.19816 13.8314 6.20052 13.8228 6.20098 13.814C6.20144 13.8051 6.20001 13.7963 6.19677 13.7881C6.19353 13.7799 6.18856 13.7725 6.1822 13.7663C6.17584 13.7602 6.16824 13.7555 6.15991 13.7526C5.62158 13.5498 5.09998 13.3052 4.59991 13.0209C4.59093 13.0158 4.58335 13.0085 4.57788 12.9997C4.5724 12.9909 4.56918 12.9809 4.56852 12.9706C4.56786 12.9603 4.56978 12.95 4.57409 12.9405C4.5784 12.9311 4.58499 12.923 4.59325 12.9167C4.69825 12.8392 4.80325 12.7584 4.90325 12.6776C4.91225 12.6703 4.92309 12.6657 4.93457 12.6642C4.94604 12.6627 4.9577 12.6645 4.96825 12.6692C8.24075 14.1392 11.7849 14.1392 15.0191 12.6692C15.0297 12.6642 15.0414 12.6622 15.0531 12.6635C15.0647 12.6649 15.0757 12.6694 15.0849 12.6767C15.1849 12.7584 15.2891 12.8392 15.3949 12.9167C15.4032 12.9228 15.4099 12.9309 15.4144 12.9402C15.4188 12.9496 15.4209 12.9598 15.4204 12.9702C15.4199 12.9805 15.4169 12.9905 15.4116 12.9994C15.4062 13.0082 15.3988 13.0156 15.3899 13.0209C14.8916 13.3076 14.3732 13.5501 13.8291 13.7517C13.8207 13.7548 13.8131 13.7595 13.8067 13.7658C13.8004 13.772 13.7954 13.7795 13.7922 13.7877C13.789 13.796 13.7875 13.8049 13.788 13.8138C13.7885 13.8227 13.7908 13.8313 13.7949 13.8392C14.0949 14.4117 14.4382 14.9567 14.8157 15.4742C14.8236 15.4848 14.8345 15.4928 14.8471 15.497C14.8596 15.5011 14.8731 15.5013 14.8857 15.4976C16.681 14.9573 18.3721 14.1174 19.8874 13.0134C19.8948 13.0082 19.901 13.0015 19.9056 12.9938C19.9102 12.986 19.9131 12.9774 19.9141 12.9684C20.3307 8.72339 19.2157 5.03506 16.9566 1.76673C16.951 1.7561 16.9419 1.74783 16.9307 1.74339ZM6.68325 10.7317C5.69825 10.7317 4.88575 9.84089 4.88575 8.74839C4.88575 7.65506 5.68241 6.76506 6.68325 6.76506C7.69158 6.76506 8.49658 7.66256 8.48075 8.74839C8.48075 9.84173 7.68408 10.7317 6.68325 10.7317ZM13.3291 10.7317C12.3432 10.7317 11.5316 9.84089 11.5316 8.74839C11.5316 7.65506 12.3274 6.76506 13.3291 6.76506C14.3374 6.76506 15.1424 7.66256 15.1266 8.74839C15.1266 9.84173 14.3382 10.7317 13.3291 10.7317Z'}" fill="${'#ADBDCC'}"></path></svg>`;
		});
		TelegramIcon = create_ssr_component(($$result, $$props, $$bindings, slots) => {
			return `<svg width="${'18'}" height="${'16'}" viewBox="${'0 0 18 16'}" class="${'w-full h-full'}" fill="${'none'}" xmlns="${'http://www.w3.org/2000/svg'}"><path d="${'M17.6993 1.8522L15.0586 14.3053C14.8593 15.1841 14.3399 15.4028 13.6018 14.9891L9.578 12.0241L7.63675 13.8916C7.42175 14.1066 7.24237 14.286 6.828 14.286L7.11737 10.1885L14.5743 3.45033C14.8986 3.16158 14.5036 3.00095 14.0705 3.29033L4.85175 9.09533L0.883 7.85283C0.0198749 7.58345 0.00424999 6.9897 1.063 6.57533L16.5861 0.594703C17.3049 0.325328 17.9336 0.754703 17.6993 1.85283V1.8522Z'}" fill="${'#ADBDCC'}"></path></svg>`;
		});
		TwitterIcon = create_ssr_component(($$result, $$props, $$bindings, slots) => {
			return `<svg width="${'19'}" height="${'16'}" class="${'w-full h-full'}" viewBox="${'0 0 19 16'}" fill="${'none'}" xmlns="${'http://www.w3.org/2000/svg'}"><path d="${'M19 1.89789C18.3013 2.21861 17.5507 2.43531 16.7616 2.53326C17.5758 2.0286 18.1849 1.23432 18.4753 0.298631C17.7104 0.769299 16.8732 1.1006 16.0001 1.27812C15.413 0.628768 14.6354 0.198364 13.7879 0.0537355C12.9405 -0.0908933 12.0707 0.0583448 11.3135 0.47828C10.5563 0.898215 9.95419 1.56535 9.60054 2.37611C9.2469 3.18688 9.16155 4.0959 9.35775 4.96206C7.80776 4.88144 6.29146 4.46412 4.90725 3.73718C3.52304 3.01023 2.30186 1.98991 1.32295 0.742437C0.988241 1.34053 0.795781 2.03398 0.795781 2.7725C0.795407 3.43734 0.953458 4.09199 1.25591 4.67838C1.55836 5.26477 1.99586 5.76476 2.5296 6.13398C1.91061 6.11358 1.30528 5.94032 0.763983 5.62863V5.68064C0.763921 6.6131 1.07529 7.51687 1.64527 8.23859C2.21524 8.96031 3.00871 9.45553 3.89104 9.64022C3.31683 9.8012 2.71481 9.82491 2.13045 9.70957C2.37939 10.5119 2.86431 11.2135 3.51731 11.7162C4.17031 12.2188 4.95871 12.4974 5.77213 12.5128C4.3913 13.6357 2.68598 14.2448 0.930503 14.2421C0.619538 14.2422 0.308837 14.2234 0 14.1858C1.78191 15.3726 3.85618 16.0024 5.97463 16C13.1459 16 17.0662 9.84739 17.0662 4.51132C17.0662 4.33796 17.062 4.16286 17.0545 3.9895C17.817 3.41825 18.4753 2.71087 18.9983 1.90049L19 1.89789Z'}" fill="${'#ADBDCC'}"></path></svg>`;
		});
		css$6 = {
			code: '.bg.svelte-111qxri.svelte-111qxri{bottom:0;display:none;height:100%;left:0;position:absolute;right:0;top:0;width:100%;z-index:-10}@media(min-width:768px){.bg.svelte-111qxri.svelte-111qxri{display:block}}.footer.svelte-111qxri.svelte-111qxri{display:flex;height:clamp(200px,28.27vw,28.27vw);padding-bottom:clamp(16px,3.33vw,3.33vw);padding-top:clamp(16px,3.33vw,3.33vw);position:relative}.arcadia-section.svelte-111qxri.svelte-111qxri{padding-left:clamp(16px,3.75vw,3.75vw);padding-right:clamp(16px,3.75vw,3.75vw);width:46%}.arcadia-section.svelte-111qxri>.logo.svelte-111qxri{height:clamp(25px,2.38vw,2.38vw);margin-bottom:clamp(16px,2.26vw,2.26vw);width:clamp(50px,8.39vw,8.39vw)}.casper-live.svelte-111qxri>.logo.svelte-111qxri{height:clamp(16px,1.96vw,1.96vw);margin-bottom:clamp(16px,2.26vw,2.26vw);width:clamp(50px,8vw,8vw)}.links.svelte-111qxri.svelte-111qxri{color:rgb(173 189 204/var(--tw-text-opacity));display:flex;flex-direction:column;font-size:clamp(8px,1.19vw,1.19vw);gap:clamp(8px,1.19vw,1.19vw)}.links.svelte-111qxri.svelte-111qxri,.title.svelte-111qxri.svelte-111qxri{--tw-text-opacity:1}.title.svelte-111qxri.svelte-111qxri{color:rgb(255 249 245/var(--tw-text-opacity));font-weight:700;margin-bottom:clamp(4px,.36vw,.36vw)}.link.svelte-111qxri.svelte-111qxri{cursor:pointer;min-width:-webkit-max-content;min-width:-moz-max-content;min-width:max-content}.link.svelte-111qxri.svelte-111qxri:hover{--tw-text-opacity:1;color:rgb(9 155 145/var(--tw-text-opacity))}.link-section.svelte-111qxri.svelte-111qxri{display:flex;gap:clamp(60px,8.93vw,8.93vw)}.socials.svelte-111qxri.svelte-111qxri{display:flex;gap:clamp(8px,1.25vw,1.25vw)}.socials.svelte-111qxri>a.svelte-111qxri{cursor:pointer;height:clamp(8px,1.25vw,1.25vw);width:clamp(8px,1.25vw,1.25vw)}',
			map: null
		};
		Footer = create_ssr_component(($$result, $$props, $$bindings, slots) => {
			$$result.css.add(css$6);
			return `<div class="${'footer svelte-111qxri'}"><img src="${'/images/png/t-footer-bg.png'}" alt="${'bg'}" class="${'bg svelte-111qxri'}" draggable="${'false'}">
	<div class="${'arcadia-section svelte-111qxri'}"><div class="${'logo svelte-111qxri'}">${validate_component(
				ArcadiaLogo,
				'ArcadiaLogo'
			).$$render($$result, {}, {}, {})}</div>
		<div class="${'link-section svelte-111qxri'}"><div class="${'links svelte-111qxri'}"><div class="${'title svelte-111qxri'}">About Arcadia</div>
				<a href="${'/'}" class="${'link svelte-111qxri'}">About us </a>
				<a href="${'/'}" class="${'link svelte-111qxri'}">Stake with us </a>
				<a href="${'/'}" class="${'link svelte-111qxri'}">Contact us </a>
				<a href="${'/'}" class="${'link svelte-111qxri'}">Terms and Service </a>
				<a href="${'/'}" class="${'link svelte-111qxri'}">Privacy Policy </a></div>
			<div class="${'links svelte-111qxri'}"><div class="${'title svelte-111qxri'}">About CSPR.Live</div>
				<a href="${'/'}" class="${'link svelte-111qxri'}">Github </a>
				<a href="${'/'}" class="${'link svelte-111qxri'}">License </a>
				<a href="${'/'}" class="${'link svelte-111qxri'}">Changelog </a>
				<a href="${'/'}" class="${'link svelte-111qxri'}">Feature Requests </a></div></div></div>

	<div class="${'casper-live svelte-111qxri'}"><div class="${'logo svelte-111qxri'}">${validate_component(
				CsprLiveLogo,
				'CsprLiveLogo'
			).$$render($$result, {}, {}, {})}</div>
		<div class="${'link-section svelte-111qxri'}"><div class="${'links svelte-111qxri'}"><div class="${'title svelte-111qxri'}">About Casper Network</div>
				<a href="${'/'}" class="${'link svelte-111qxri'}">CasperLabs </a>
				<a href="${'/'}" class="${'link svelte-111qxri'}">Casper Association </a>
				<a href="${'/'}" class="${'link svelte-111qxri'}">Highway protocol </a>
				<a href="${'/'}" class="${'link svelte-111qxri'}">Techinical design </a></div>
			<div class="${'links svelte-111qxri'}"><div class="${'title svelte-111qxri'}">Developer Resources</div>
				<a href="${'/'}" class="${'link svelte-111qxri'}">Documentation </a>
				<a href="${'/'}" class="${'link svelte-111qxri'}">Github </a>
				<div class="${'socials svelte-111qxri'}"><a href="${'/'}" class="${'discord svelte-111qxri'}">${validate_component(
				DiscordIcon,
				'DiscordIcon'
			).$$render($$result, {}, {}, {})}</a>
					<a href="${'/'}" class="${'telegram svelte-111qxri'}">${validate_component(
				TelegramIcon,
				'TelegramIcon'
			).$$render($$result, {}, {}, {})}</a>
					<a href="${'/'}" class="${'twitter svelte-111qxri'}">${validate_component(
				TwitterIcon,
				'TwitterIcon'
			).$$render($$result, {}, {}, {})}</a></div></div></div></div>
</div>`;
		});
		css$5 = {
			code: '.home-stats-section.svelte-1rvsavm{--tw-border-opacity:0.5;--tw-backdrop-blur:blur(8px);align-items:center;-webkit-backdrop-filter:var(--tw-backdrop-blur) var(--tw-backdrop-brightness) var(--tw-backdrop-contrast) var(--tw-backdrop-grayscale) var(--tw-backdrop-hue-rotate) var(--tw-backdrop-invert) var(--tw-backdrop-opacity) var(--tw-backdrop-saturate) var(--tw-backdrop-sepia);backdrop-filter:var(--tw-backdrop-blur) var(--tw-backdrop-brightness) var(--tw-backdrop-contrast) var(--tw-backdrop-grayscale) var(--tw-backdrop-hue-rotate) var(--tw-backdrop-invert) var(--tw-backdrop-opacity) var(--tw-backdrop-saturate) var(--tw-backdrop-sepia);border-color:rgb(121 225 237/var(--tw-border-opacity));border-radius:clamp(10px,1.19vw,1.19vw);border-width:clamp(1px,.06vw,.06vw);display:flex;gap:clamp(10px,1.43vw,1.43vw);height:clamp(100px,5.5vw,5.5vw);padding:clamp(4px,.48vw,.48vw) clamp(20px,1.5vw,1.5vw);width:clamp(500px,46.96vw,46.96vw)}.stat-column.svelte-1rvsavm{line-height:1;width:100%}.vt.svelte-1rvsavm{--tw-border-opacity:0.5;border-color:rgb(242 243 245/var(--tw-border-opacity));border-right-width:1px;height:100%}.title.svelte-1rvsavm{--tw-text-opacity:1;color:rgb(207 207 207/var(--tw-text-opacity));font-size:clamp(8px,.7vw,.7vw);margin-bottom:clamp(2px,.3vw,.3vw)}.value.svelte-1rvsavm{font-size:clamp(10px,1.43vw,1.43vw);font-weight:500;margin-bottom:clamp(2px,.24vw,.24vw)}.detail.svelte-1rvsavm,.value.svelte-1rvsavm{--tw-text-opacity:1;color:rgb(255 255 255/var(--tw-text-opacity))}.detail.svelte-1rvsavm{font-size:clamp(8px,.75vw,.75vw)}',
			map: null
		};
		OtherStatsSection = create_ssr_component(($$result, $$props, $$bindings, slots) => {
			$$result.css.add(css$5);
			return `<div class="${'home-stats-section header-stats-background svelte-1rvsavm'}"><div class="${'stat-column svelte-1rvsavm'}"><div class="${'title svelte-1rvsavm'}">BLOCK HEIGHT</div>
		<div class="${'value svelte-1rvsavm'}">${escape('861,309')}</div>
		<div class="${'detail svelte-1rvsavm'}">${escape('55 sec ago')}</div></div>

	<div class="${'vt svelte-1rvsavm'}"></div>

	<div class="${'stat-column svelte-1rvsavm'}"><div class="${'title svelte-1rvsavm'}">APY</div>
		<div class="${'value svelte-1rvsavm'}">${escape('10.60%')}</div>
		<div class="${'detail svelte-1rvsavm'}">${escape('Annual Percentage Yield')}</div></div>

	<div class="${'vt svelte-1rvsavm'}"></div>

	<div class="${'stat-column svelte-1rvsavm'}"><div class="${'title svelte-1rvsavm'}">CSPR PRICE</div>
		<div class="${'value svelte-1rvsavm'}">${escape('$0.0264')}</div>
		<div class="${'detail svelte-1rvsavm'}">${escape('$135,498,998 Market Cap')}</div></div>

	<div class="${'vt svelte-1rvsavm'}"></div>

	<div class="${'stat-column svelte-1rvsavm'}"><div class="${'title svelte-1rvsavm'}">CIRCULATING SUPPLY</div>
		<div class="${'value svelte-1rvsavm'}">${escape('5,140,696,711')}</div>
		<div class="${'detail svelte-1rvsavm'}">${escape('47.0% of 10,934,884,629')}</div></div>
</div>`;
		});
		NavbarChevron = create_ssr_component(($$result, $$props, $$bindings, slots) => {
			return `<svg width="${'16'}" height="${'16'}" class="${'h-full w-full'}" viewBox="${'0 0 16 16'}" fill="${'none'}" xmlns="${'http://www.w3.org/2000/svg'}"><path d="${'M9.84882 7.00001L7.00001 9.74511L4.15116 7L3.5 7.62745L6.99999 11L10.5 7.62746L9.84882 7.00001Z'}" fill="${'white'}"></path></svg>`;
		});
		UserIcon = create_ssr_component(($$result, $$props, $$bindings, slots) => {
			return `<svg width="${'18'}" height="${'18'}" class="${'h-full w-full'}" viewBox="${'0 0 18 17'}" fill="${'none'}" xmlns="${'http://www.w3.org/2000/svg'}"><path d="${'M9.00008 0.166672C4.40008 0.166672 0.666748 3.90001 0.666748 8.5C0.666748 13.1 4.40008 16.8333 9.00008 16.8333C13.6001 16.8333 17.3334 13.1 17.3334 8.5C17.3334 3.90001 13.6001 0.166672 9.00008 0.166672ZM9.00008 3.50001C10.6084 3.50001 11.9167 4.80834 11.9167 6.41667C11.9167 8.025 10.6084 9.33334 9.00008 9.33334C7.39175 9.33334 6.08341 8.025 6.08341 6.41667C6.08341 4.80834 7.39175 3.50001 9.00008 3.50001ZM9.00008 15.1667C7.30841 15.1667 5.30841 14.4833 3.88341 12.7667C5.34309 11.6214 7.14476 10.999 9.00008 10.999C10.8554 10.999 12.6571 11.6214 14.1167 12.7667C12.6917 14.4833 10.6917 15.1667 9.00008 15.1667Z'}" fill="${'url(#paint0_linear_264_706)'}"></path><defs><linearGradient id="${'paint0_linear_264_706'}" x1="${'9.00008'}" y1="${'0.166672'}" x2="${'9.00008'}" y2="${'16.8333'}" gradientUnits="${'userSpaceOnUse'}"><stop stop-color="${'#1737A3'}"></stop><stop offset="${'1'}" stop-color="${'#099B91'}"></stop></linearGradient></defs></svg>`;
		});
		css$4 = {
			code: '.navbar.svelte-1c71zzk{justify-content:space-between}.nav-items.svelte-1c71zzk,.navbar.svelte-1c71zzk{display:flex}.nav-items.svelte-1c71zzk{--tw-text-opacity:0.5;color:rgb(255 255 255/var(--tw-text-opacity));font-size:clamp(10px,.83vw,.83vw);gap:clamp(16px,1.79vw,1.79vw)}.nav-item.svelte-1c71zzk{align-items:center;cursor:pointer;display:flex;min-width:-webkit-max-content;min-width:-moz-max-content;min-width:max-content}.logo.svelte-1c71zzk{height:clamp(16px,1.96vw,1.96vw)}.chevron.svelte-1c71zzk{height:clamp(14px,.95vw,.95vw);margin-left:clamp(4px,.36vw,.36vw);width:clamp(14px,.95vw,.95vw)}.selected.svelte-1c71zzk,.signin.svelte-1c71zzk{--tw-text-opacity:1;color:rgb(255 255 255/var(--tw-text-opacity))}.signin.svelte-1c71zzk{align-items:center;cursor:pointer;display:flex}.user-icon.svelte-1c71zzk{height:clamp(14px,1.07vw,1.07vw);margin-right:clamp(4px,.36vw,.36vw);width:clamp(14px,1.07vw,1.07vw)}',
			map: null
		};
		selected = 'blockchain';
		Navbar = create_ssr_component(($$result, $$props, $$bindings, slots) => {
			...
			return `<div class="${'navbar svelte-1c71zzk'}"><div class="${'logo svelte-1c71zzk'}">${validate_component(
				CsprLiveLogo,
				'CsprLiveLogo'
			).$$render($$result, {}, {}, {})}</div>
	<div class="${'nav-items svelte-1c71zzk'}">${each(navItems, (navItem) => {
				return `<div class="${'nav-item svelte-1c71zzk'}"><div class="${[
					'text svelte-1c71zzk',
					navItem.text.toLowerCase() === selected ? 'selected' : ''
				]
					.join(' ')
					.trim()}">${escape(navItem.text)}</div>
				${
					navItem.dropdown.length > 0
						? `<div class="${'chevron svelte-1c71zzk'}">${validate_component(
								NavbarChevron,
								'NavbarChevron'
						  ).$$render($$result, {}, {}, {})}
					</div>`
		...
		<div class="${'signin svelte-1c71zzk'}"><div class="${'user-icon svelte-1c71zzk'}">${validate_component(
				UserIcon,
				'UserIcon'
			).$$render($$result, {}, {}, {})}</div>
			<div class="${'text'}">Sign In</div></div></div>
</div>`;
		});
		SearchIcon = create_ssr_component(($$result, $$props, $$bindings, slots) => {
			return `<svg width="${'16'}" height="${'16'}" class="${'w-full h-full'}" viewBox="${'0 0 16 16'}" fill="${'none'}" xmlns="${'http://www.w3.org/2000/svg'}"><path d="${'M10.4958 11.6272L14.5593 15.6907L15.6907 14.5594L11.6271 10.4958C12.4874 9.3935 13 8.00661 13 6.5C13 2.91015 10.0898 3.13835e-07 6.5 0C2.91015 6.3984e-07 -6.3984e-07 2.91015 0 6.5C-3.13835e-07 10.0899 2.91015 13 6.5 13C8.0066 13 9.39347 12.4874 10.4958 11.6272ZM11.4 6.5C11.4 9.2062 9.20619 11.4 6.5 11.4C3.7938 11.4 1.6 9.2062 1.6 6.5C1.6 3.7938 3.7938 1.6 6.5 1.6C9.20619 1.6 11.4 3.7938 11.4 6.5Z'}" fill="${'white'}"></path></svg>`;
		});
		css$3 = {
			code: '.filter.svelte-4lv7v1{--tw-bg-opacity:1;--tw-text-opacity:1;background-color:rgb(9 20 90/var(--tw-bg-opacity));border-bottom-right-radius:.24vw;border-top-right-radius:.24vw;color:rgb(255 255 255/var(--tw-text-opacity));font-size:clamp(10px,.83vw,.83vw);height:clamp(10px,2.5vw,2.5vw);width:clamp(100px,34.58vw,34.58vw)}.filter.svelte-4lv7v1,.filter-dropdown.svelte-4lv7v1{align-items:center;display:flex}.filter-dropdown.svelte-4lv7v1{--tw-bg-opacity:1;background-color:rgb(9 24 114/var(--tw-bg-opacity));cursor:pointer;height:100%;justify-content:center;width:20%}input.svelte-4lv7v1{-webkit-appearance:none;-moz-appearance:none;appearance:none;background-color:transparent;flex-grow:1;outline:2px solid transparent;outline-offset:2px;padding-left:clamp(16px,.95vw,.95vw);padding-right:clamp(16px,.95vw,.95vw);width:100%}.chevron.svelte-4lv7v1{height:clamp(14px,.95vw,.95vw);margin-left:clamp(4px,.36vw,.36vw);width:clamp(14px,.95vw,.95vw)}.search.svelte-4lv7v1{--tw-gradient-from:#173fa2;--tw-gradient-stops:var(--tw-gradient-from),var(--tw-gradient-to,rgba(23,63,162,0));--tw-gradient-to:#0c8d94;align-items:center;background-image:linear-gradient(to right,var(--tw-gradient-stops));border-bottom-right-radius:.24vw;border-top-right-radius:.24vw;cursor:pointer;display:flex;height:100%;justify-content:center;width:clamp(20px,3.36vw,3.36vw)}.search-icon.svelte-4lv7v1{height:clamp(10px,.95vw,.95vw);width:clamp(10px,.95vw,.95vw)}',
			map: null
		};
		Filter = create_ssr_component(($$result, $$props, $$bindings, slots) => {
			...
			return `<div class="${'filter svelte-4lv7v1'}"><div class="${'filter-dropdown svelte-4lv7v1'}"><div class="${'text'}">Filter</div>
		<div class="${'chevron svelte-4lv7v1'}">${validate_component(
				NavbarChevron,
				'NavbarChevron'
			).$$render($$result, {}, {}, {})}</div></div>

	<input type="${'text'}" name="${'filter'}" placeholder="${'Search by Address / Txn Hash / Block / Token / Ens'}" class="${'svelte-4lv7v1'}"${add_attribute(
				'value',
				value,
				0
			)}>

	<div class="${'search svelte-4lv7v1'}"><div class="${'search-icon svelte-4lv7v1'}">${validate_component(
				SearchIcon,
				'SearchIcon'
			).$$render($$result, {}, {}, {})}</div></div>
</div>`;
		...
		css$22 = {
			code: '.home-stats-section.svelte-12yoc7k.svelte-12yoc7k{--tw-border-opacity:0.5;--tw-backdrop-blur:blur(8px);align-items:center;-webkit-backdrop-filter:var(--tw-backdrop-blur) var(--tw-backdrop-brightness) var(--tw-backdrop-contrast) var(--tw-backdrop-grayscale) var(--tw-backdrop-hue-rotate) var(--tw-backdrop-invert) var(--tw-backdrop-opacity) var(--tw-backdrop-saturate) var(--tw-backdrop-sepia);backdrop-filter:var(--tw-backdrop-blur) var(--tw-backdrop-brightness) var(--tw-backdrop-contrast) var(--tw-backdrop-grayscale) var(--tw-backdrop-hue-rotate) var(--tw-backdrop-invert) var(--tw-backdrop-opacity) var(--tw-backdrop-saturate) var(--tw-backdrop-sepia);border-color:rgb(121 225 237/var(--tw-border-opacity));border-radius:clamp(10px,1.19vw,1.19vw);border-width:clamp(1px,.06vw,.06vw);display:flex;gap:clamp(10px,1.43vw,1.43vw);height:clamp(100px,16.13vw,16.13vw);padding:clamp(10px,1.73vw,1.73vw);width:clamp(500px,92.44vw,92.44vw)}.stat-column.svelte-12yoc7k.svelte-12yoc7k{height:100%;line-height:1;width:clamp(100px,17.86vw,17.86vw)}.stat-column.svelte-12yoc7k>div.svelte-12yoc7k{height:50%;padding-left:clamp(20px,1.5vw,1.5vw)}.top.svelte-12yoc7k.svelte-12yoc7k{--tw-border-opacity:0.5;border-bottom-width:1px;border-color:rgb(242 243 245/var(--tw-border-opacity))}.bottom.svelte-12yoc7k.svelte-12yoc7k{margin-top:clamp(8px,.95vw,.95vw)}.vt.svelte-12yoc7k.svelte-12yoc7k{--tw-border-opacity:0.5;border-color:rgb(242 243 245/var(--tw-border-opacity));border-right-width:1px;height:100%}.title.svelte-12yoc7k.svelte-12yoc7k{--tw-text-opacity:1;color:rgb(207 207 207/var(--tw-text-opacity));font-size:clamp(8px,.95vw,.95vw);margin-bottom:clamp(2px,.5vw,.5vw)}.value.svelte-12yoc7k.svelte-12yoc7k{font-size:clamp(14px,1.67vw,1.67vw);font-weight:500;margin-bottom:clamp(2px,.4vw,.4vw)}.detail.svelte-12yoc7k.svelte-12yoc7k,.value.svelte-12yoc7k.svelte-12yoc7k{--tw-text-opacity:1;color:rgb(255 255 255/var(--tw-text-opacity))}.detail.svelte-12yoc7k.svelte-12yoc7k{font-size:clamp(10px,1.07vw,1.07vw)}',
			map: null
		};
		HomeStatsSection = create_ssr_component(($$result, $$props, $$bindings, slots) => {
			$$result.css.add(css$22);
			return `<div class="${'home-stats-section header-stats-background svelte-12yoc7k'}"><div class="${'stat-column svelte-12yoc7k'}"><div class="${'top svelte-12yoc7k'}"><div class="${'title svelte-12yoc7k'}">BLOCK HEIGHT</div>
			<div class="${'value svelte-12yoc7k'}">${escape('861,309')}</div>
			<div class="${'detail svelte-12yoc7k'}">${escape('55 sec ago')}</div></div>
		<div class="${'bottom svelte-12yoc7k'}"><div class="${'title svelte-12yoc7k'}">CSPR PRICE</div>
			<div class="${'value svelte-12yoc7k'}">${escape('$0.0264')}</div>
			<div class="${'detail svelte-12yoc7k'}">${escape('$135,498,998 Market Cap')}</div></div></div>

	<div class="${'vt svelte-12yoc7k'}"></div>

	<div class="${'stat-column svelte-12yoc7k'}"><div class="${'top svelte-12yoc7k'}"><div class="${'title svelte-12yoc7k'}">ACTIVE VALIDATORS</div>
			<div class="${'value svelte-12yoc7k'}">${escape('100')}</div>
			<div class="${'detail svelte-12yoc7k'}">${escape('out of 119 active bids')}</div></div>
		<div class="${'bottom svelte-12yoc7k'}"><div class="${'title svelte-12yoc7k'}">CIRCULATING SUPPLY</div>
			<div class="${'value svelte-12yoc7k'}">${escape('5,140,696,711')}</div>
			<div class="${'detail svelte-12yoc7k'}">${escape('47.0% of 10,934,884,629')}</div></div></div>

	<div class="${'vt svelte-12yoc7k'}"></div>

	<div class="${'stat-column svelte-12yoc7k'}"><div class="${'top svelte-12yoc7k'}"><div class="${'title svelte-12yoc7k'}">TOTAL STAKE BONDED</div>
			<div class="${'value svelte-12yoc7k'}">${escape('8,255,902,991')}</div>
			<div class="${'detail svelte-12yoc7k'}">${escape('75.50% of Total Supply')}</div></div>
		<div class="${'bottom svelte-12yoc7k'}"><div class="${'title svelte-12yoc7k'}">TOTAL TRANSFERS</div>
			<div class="${'value svelte-12yoc7k'}">${escape('8,221,2423')}</div></div></div>
	...
	<div class="${'graph'}"></div>
		...
		css$12 = {
			code: '.header.svelte-pyebgn{display:flex;flex-direction:column;row-gap:2vw}@media(min-width:640px){.header.svelte-pyebgn{padding:1rem}}@media(min-width:768px){.header.svelte-pyebgn{padding-bottom:clamp(16px,.95vw,.95vw);padding-left:clamp(16px,3.57vw,3.57vw);padding-right:clamp(16px,3.57vw,3.57vw);padding-top:clamp(16px,.95vw,.95vw)}}.header.svelte-pyebgn{background-position:50%;background-repeat:no-repeat;background-size:auto;background:url(/images/png/header-bg.png) 50%/cover}.header-flex.svelte-pyebgn{align-items:center;display:flex;justify-content:space-between}',
			map: null
		};
		Header = create_ssr_component(($$result, $$props, $$bindings, slots) => {
			...
			return `<div class="${'header svelte-pyebgn'}">${validate_component(
				Navbar,
				'Navbar'
			).$$render($$result, {}, {}, {})}
	${
		...
		${validate_component(HomeStatsSection, 'HomeStatsSection').$$render($$result, {}, {}, {})}`
			: `<div class="${'header-flex svelte-pyebgn'}">${validate_component(
					OtherStatsSection,
					'OtherStatsSection'
			  ).$$render($$result, {}, {}, {})}
		...
		css2 = {
			code: '.content.svelte-vn899v{height:80vh}',
			map: null
		};
		Components = create_ssr_component(($$result, $$props, $$bindings, slots) => {
			$$result.css.add(css2);
			return `${validate_component(Header, 'Header').$$render($$result, {}, {}, {})}
<div class="${'content svelte-vn899v'}"></div>
${validate_component(Footer, 'Footer').$$render($$result, {}, {}, {})}
${validate_component(BottomFooter, 'BottomFooter').$$render($$result, {}, {}, {})}`;
		});
	}
});
...
var init__4 = __esm({
	'.svelte-kit/output/server/nodes/2.js'() {
		...
		index4 = 2;
		file5 = 'pages/components.svelte-c626bf5e.js';
		imports4 = ['pages/components.svelte-c626bf5e.js', 'chunks/index-d017537a.js'];
		stylesheets4 = ['assets/pages/components.svelte-714453e1.css'];
	}
});
...
// node_modules/.pnpm/@sveltejs+kit@1.0.0-next.360_svelte@3.46.4+vite@2.9.13/node_modules/@sveltejs/kit/dist/node/polyfills.js
...
function requireFormdata() {
	...
	function makeEntry(name, value, filename) {
		...
		if (typeof value === 'string') {
			...
			if (!isFileLike(value)) {
				value =
					value instanceof Blob4
						? new File3([value], 'blob', { type: value.type })
						: new FileLike(value, 'blob', { type: value.type });
			}
			if (filename !== void 0) {
				value =
					value instanceof File3
						? new File3([value], filename, { type: value.type })
...
var { Readable, Duplex, PassThrough } = import_stream.default;
var {
...
function requireResponse() {
	...
	const { redirectStatus, nullBodyStatus, DOMException: DOMException2 } = requireConstants$1();
...
var manifest = {
	...
	assets: /* @__PURE__ */ new Set([
		'images/png/b-footer-bg.png',
		'images/png/favicon.png',
		'images/png/header-bg.png',
		'images/png/logo.png',
		'images/png/t-footer-bg.png'
	]),
	mimeTypes: { '.png': 'image/png' },
	_: {
		entry: {
			file: 'start-44b38a38.js',
			imports: ['start-44b38a38.js', 'chunks/index-d017537a.js'],
			stylesheets: []
		},
		nodes: [
