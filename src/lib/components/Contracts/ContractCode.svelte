...
<div class="contract-code">
        ...
        <div class="extras">
            ...
            <table>
                ...
                <tr>
                    ...
                    <td class="value">{otherSettings.text} <span class="green" on:click={() => {
                        goto(otherSettings.link.url);
                    }}>{otherSettings.link.text}</span></td>
                </tr>
            </table>
        </div>
    </div>
    ...
    <div class="content">
        ...
        <CodeViewer code={sampleSolidityCode}>
            ...
            <div class="title-text">
                Constructor Arguments <span class="grey">(ABI-Encoded and is the last bytes of the Contract Creation Code above)</span>
            </div>
        </CodeViewer>
