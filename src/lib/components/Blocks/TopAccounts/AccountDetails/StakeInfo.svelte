...
<style lang="postcss">
	.overview {
		@apply pt-[1.73vw] pb-[2.08vw] pl-[1.43vw] pr-[1.90vw];
		@apply w-[44.7vw] h-max;
	...
	.value {
		@apply text-[1.07vw] text-color-table-header;
		@apply flex items-center gap-[0.24vw];
	}

	td {
		@apply pb-[2.2vw] mr-[18.33vw];
		@apply align-top;
	}
