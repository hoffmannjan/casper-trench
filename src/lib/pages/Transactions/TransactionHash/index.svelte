		...
		<div class="wrapper" bind:this={toDownload}>
			<button
				...
				on:click={() => {
					...
					// a.document.write('<style ✂prettier:content✂="LmRvd25sb2FkLWJ1dHRvbiB7ZGlzcGxheTogbm9uZTsgfSBib2R5ID4gZGl2IHtkaXNwbGF5OiBmbGV4OyBmbGV4LWRpcmVjdGlvbjogY29sdW1uOyBhbGlnbi1pdGVtczogY2VudGVyO30=" ✂prettier:content✂=""></style>');
					// a.document.close();
					// a.print();
				}}
			>
